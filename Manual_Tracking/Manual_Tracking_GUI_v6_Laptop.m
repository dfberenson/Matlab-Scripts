function varargout = Manual_Tracking_GUI_v6_Laptop(varargin)
% MANUAL_TRACKING_GUI_V6_LAPTOP MATLAB code for Manual_Tracking_GUI_v6_Laptop.fig
%      MANUAL_TRACKING_GUI_V6_LAPTOP, by itself, creates a new MANUAL_TRACKING_GUI_V6_LAPTOP or raises the existing
%      singleton*.
%
%      H = MANUAL_TRACKING_GUI_V6_LAPTOP returns the handle to a new MANUAL_TRACKING_GUI_V6_LAPTOP or the handle to
%      the existing singleton*.
%
%      MANUAL_TRACKING_GUI_V6_LAPTOP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MANUAL_TRACKING_GUI_V6_LAPTOP.M with the given input arguments.
%
%      MANUAL_TRACKING_GUI_V6_LAPTOP('Property','Value',...) creates a new MANUAL_TRACKING_GUI_V6_LAPTOP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Manual_Tracking_GUI_v6_Laptop_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Manual_Tracking_GUI_v6_Laptop_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Manual_Tracking_GUI_v6_Laptop

% Last Modified by GUIDE v2.5 03-Jul-2018 10:16:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Manual_Tracking_GUI_v6_Laptop_OpeningFcn, ...
    'gui_OutputFcn',  @Manual_Tracking_GUI_v6_Laptop_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Manual_Tracking_GUI_v6_Laptop is made visible.
function Manual_Tracking_GUI_v6_Laptop_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Manual_Tracking_GUI_v6_Laptop (see VARARGIN)

% Choose default command line output for Manual_Tracking_GUI_v6_Laptop
...
%with arguments
handles.expt_folder = 'H:/';
handles.expt_name = 'DFB_180627_HMEC_1GFiii_palbo_2';
handles.startframe = 1;
handles.endframe = 516;
...
% UIWAIT makes Manual_Tracking_GUI_v6_Laptop wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Manual_Tracking_GUI_v6_Laptop_OutputFcn(hObject, eventdata, handles)
