...
for position = [3,5,6,7,8,9,10,11,12]
    ...
    imstack0 = readStack([source_folder '\' expt_name '\' expt_name infix pos suffixes]);
    imstack1 = readStack([source_folder '\' expt_name '\' expt_name infix pos '_1' suffixes]);
    imstack2 = readStack([source_folder '\' expt_name '\' expt_name infix pos '_2' suffixes]);
    imstack3 = readStack([source_folder '\' expt_name '\' expt_name infix pos '_3' suffixes]);
    ...
    save([destination_subfolder 'Pos' pos '_mode_intensities.mat'],...
    ...
    destination_superfolder = 'E:\Aivia';
    destination_subfolder = [destination_superfolder '\' expt_name '\Image_Sequences\Pos' pos '\'];
