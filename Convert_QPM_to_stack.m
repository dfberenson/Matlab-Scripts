...
for i = 1:504
    ...
    phase_name = ['PHA_img_channel000_position0' num2str(position) '_time' sprintf('%09d',i) '_z000_flat.tif'];
    fluo1_name = ['INT_img_channel000_position0' num2str(position) '_time' sprintf('%09d',i) '_z000fluo1_flat.tif'];
    fluo2_name = ['INT_img_channel000_position0' num2str(position) '_time' sprintf('%09d',i) '_z000fluo2_flat.tif'];
...
position = 21;
folder = ['F:\DFB_imaging_experiments\DFB_180501_QPM_HMEC_1GFiii_4\Pos' num2str(position)];
phase_stack_name = 'Phase.tif';
...
for i = 1:504
    disp(['Writing frame ' num2str(i)])
    phase_name = ['img_channel001_position0' num2str(position) '_time' sprintf('%09d',i) '_z000.tif'];
    GFP_name = ['img_channel002_position0' num2str(position) '_time' sprintf('%09d',i) '_z000.tif'];
    mCherry_name = ['img_channel003_position0' num2str(position) '_time' sprintf('%09d',i) '_z000.tif'];
