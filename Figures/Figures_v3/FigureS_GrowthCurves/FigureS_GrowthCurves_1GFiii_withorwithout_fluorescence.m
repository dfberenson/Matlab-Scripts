...
Cells_with = table2array(readtable('C:\Users\Skotheim Lab\Box Sync\Daniel Berenson''s Files\Data\DFB_190306_HMEC_1GFiii cell counts.xlsx','Sheet','DFB_190306 Fluorescence','ReadVariableNames',false));
...
Cells_without = table2array(readtable('C:\Users\Skotheim Lab\Box Sync\Daniel Berenson''s Files\Data\DFB_190306_HMEC_1GFiii cell counts.xlsx','Sheet','DFB_190306 White','ReadVariableNames',false));
...
hold on
box on
shadedErrorBar(0:24:72,Mean_with,Stderr_with,'r')
shadedErrorBar(0:24:72,Mean_without,Stderr_without,'k')
