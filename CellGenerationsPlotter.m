...
framerate = input('Framerate (mins/frame): ');
...
if numchannels == 1
    ...
    hold on
    timeX = [1:length(CellX_generations)] * framerate/60;
    plot(timeX, CellX_generations, color)
    hold off
end
...
%     channelname2 = input('Channel 2: ');
    ...
    hold on
    timeX = [1:length(CellX_generations_channel1)] * framerate/60;
    plot(timeX,CellX_generations_channel1 * scale1, color1)
    plot(timeX,CellX_generations_channel2 * scale2, color2)
    xlabel('Time (h)')
